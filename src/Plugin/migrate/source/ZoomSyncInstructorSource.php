...
/**
 * @MigrateSource(
 *   id = "openy_gc_zoom_sync_instructor_source"
 * )
 */
class ZoomSyncInstructorSource extends SourcePluginBase implements ContainerFactoryPluginInterface {
  ...
  protected function initializeIterator() {
    $instructors = $this->zoomSyncClient->getInstructors();
    ...
    foreach ($instructors as $instructor) {
      $id = str_replace(' ', '_', strtolower($instructor));
